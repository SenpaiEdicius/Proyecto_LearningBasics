        ...
        if(errors){
            ...
            paxios.post(
                "/api/user/forgot",
                {
                    ...
                    htmlBody: '<div style="background-color: #27b863; padding: 50px; color: #fff; font-size:50px; text-align: center;">'+
            ...
            <Page pageTitle="forgot">
                <section className="page-login">
                        <div className="login-data col-s-12 col-m-4 col-4 col-l-3">
                            ...
                            <br/>
                            <h1 className="center main-color">Correo enviado para realizar el cambio de Contraseña</h1>         
                        </div>
        ...
        return (
            ...
            <section className="page-login">
                    <div className="login-data col-s-12 col-m-4 col-4 col-l-3">
                        ...
                        />
                        <Button_F>
                            <button className="button-3 col-s-11" onClick={this.onClickForgot}>Entrar</button>
                        </Button_F>            
                    </div>
                    <div className="login-background col-m-8 col-6 col-offset-1 col-offset-l-2 hide-s">
                        <img src={img} alt="Imagen de Fondo"  className="col-m-12 no-padding"/>
